...
@time    : none
**************************************************/
SweptSurfaceTransform::SweptSurfaceTransform(QWidget *parent) :
...
@time    : none
**************************************************/
SweptSurfaceTransform::~SweptSurfaceTransform() {}
...
@time    : none
**************************************************/
int SweptSurfaceTransform::findSpan(int numOfCtlPoint, int order, double u, const std::vector<double> &U) {
...
@time    : none
**************************************************/
void SweptSurfaceTransform::basisFuns(int i, double u, int order, const std::vector<double> &U, std::vector<double> &base) {
	base.resize(order + 1);
	base[0] = 1.0;
...
@time    : none
**************************************************/
void SweptSurfaceTransform::curvePoint(int n, int p, const std::vector<double>&U, std::vector<Point3d>&P, double u,
...
@time    : none
**************************************************/
//void SweptSurfaceTransform::surfacePoint(int n, int p, const std::vector<double>&U, int m, int q, const std::vector<double> &V,
...
@time    : none
**************************************************/
void SweptSurfaceTransform::genPoints(std::string str) {
	jsonReader(str);
...
@time    : none
**************************************************/
void SweptSurfaceTransform::jsonReader(std::string fileName) {
	if (fileName == "") {
...
@time    : none
**************************************************/
void SweptSurfaceTransform::initializeGL() {
...
@time    : none
**************************************************/
void SweptSurfaceTransform::resizeGL(int width, int height)
{
	// 防止height为0
	if (height == 0) {
		height = 1;
...
@time    : none
**************************************************/
void SweptSurfaceTransform::paintGL() {
	//genPoints("normal");
...
@time    : none
**************************************************/
void SweptSurfaceTransform::mousePressEvent(QMouseEvent *e) {
	lastPos = e->pos();
	flag = 1;
}
...
@time    : none
**************************************************/
void SweptSurfaceTransform::mouseReleaseEvent(QMouseEvent *e) {
	flag = -1;
}
...
@time    : none
**************************************************/
void SweptSurfaceTransform::mouseMoveEvent(QMouseEvent *e) {
	if (flag) {
