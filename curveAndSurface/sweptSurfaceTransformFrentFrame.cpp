...
@time    : none
**************************************************/
SweptSurfaceTransformFrentFrame::SweptSurfaceTransformFrentFrame(QWidget *parent) :
...
@time    : none
**************************************************/
SweptSurfaceTransformFrentFrame::~SweptSurfaceTransformFrentFrame() {}
...
@time    : none
**************************************************/
int SweptSurfaceTransformFrentFrame::findSpan(int numOfCtlPoint, int order, double u, const std::vector<double> &U) {
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::basisFuns(int i, double u, int order, const std::vector<double> &U, std::vector<double> &base) {
	base.resize(order + 1);
	base[0] = 1.0;
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::curvePoint(int n, int p, const std::vector<double>&U, std::vector<Point3d>&P, double u,
...
@time    : none
**************************************************/
//void SweptSurfaceTransformFrentFrame::surfacePoint(int n, int p, const std::vector<double>&U, int m, int q, const std::vector<double> &V,
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::genPoints(std::string str) {
	jsonReader(str);
	std::cout << "[DEBUG]genPoint" << std::endl;
	vector3d Bv(1, 0, 0);
	Matrix33 identity = Matrix33::getIdentityMatrix();
	sweptEntity.getSweepSurface1(T, C, Bv, identity, 10);// 得到两条曲线生成的一个曲面的结构体
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::jsonReader(std::string fileName) {
	if (fileName == "") {
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::initializeGL() {
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::resizeGL(int width, int height)
{
	// 防止height为0
	if (height == 0) {
		height = 1;
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::paintGL() {
	//genPoints("normal");
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::mousePressEvent(QMouseEvent *e) {
	lastPos = e->pos();
	flag = 1;
}
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::mouseReleaseEvent(QMouseEvent *e) {
	flag = -1;
}
...
@time    : none
**************************************************/
void SweptSurfaceTransformFrentFrame::mouseMoveEvent(QMouseEvent *e) {
	if (flag) {
